...
#     ./submit.sh run_LR6.sh          # detects machine, picks sbatch or qsub
...
workdir_lo=${scratchdir}/run_lo6_diags
...
ln -s ${rootdir}/input_binaries_lores6/viscd*.bin .
ln -s ${rootdir}/input_binaries_lores6/viscz*.bin .
