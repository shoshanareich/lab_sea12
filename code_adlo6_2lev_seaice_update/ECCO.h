...
C                 the current model integration.
C     nhoursrec :: number of hourly records that will be generated by
C                 the current model integration.
