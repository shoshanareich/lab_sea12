...
catn      INTEGER inSEAICEadjMODE, outSEAICEadjMODE
CMM(
      INTEGER MSfacX
      INTEGER MSfacY
CMM)
...
catn     &      ,inSEAICEadjMODE, outSEAICEadjMODE
CMM(
     &       , MSfacX, MSfacY
CMM)
...
C      _RL inAdviscA4Grid, inAdviscAhGrid, inAdviscArNr
C      _RL inAddiffKrNrT, inAddiffKrNrS
catn      _RL inAddiffKhT, inAddiffKhS
catn      _RL inAddiffK4T, inAddiffK4S
C      _RL outAdviscA4Grid, outAdviscAhGrid, outAdviscArNr
C      _RL outAddiffKrNrT, outAddiffKrNrS
catn      _RL outAddiffKhT, outAddiffKhS
catn      _RL outAddiffK4T, outAddiffK4S

      COMMON /AUTODIFF_PARM_R/
     &  viscFacInAd, viscFacInFw, SIregFacInAd, SIregFacInFw
catn     & ,inAddiffKhT, inAddiffKhS,
catn     &  inAddiffK4T, inAddiffK4S,
catn     &  outAddiffKhT, outAddiffKhS,
catn     &  outAddiffK4T, outAddiffK4S
C     & ,inAdviscA4Grid, inAdviscAhGrid, inAdviscArNr,
C     &  inAddiffKrNrT, inAddiffKrNrS,
C     &  outAdviscA4Grid, outAdviscAhGrid, outAdviscArNr,
